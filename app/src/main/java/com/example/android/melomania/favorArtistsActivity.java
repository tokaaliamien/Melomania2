...
public class FavorArtistsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favor_artists);
        ...
        mFlowLayout.setOnTagClickListener(new TagFlowLayout.OnTagClickListener() {
            ...
            public boolean onTagClick(View view, int position, FlowLayout parent) {
                ...
                Toast.makeText(FavorArtistsActivity.this, list.get(position), Toast.LENGTH_SHORT).show();
                return true;
            }
        });
